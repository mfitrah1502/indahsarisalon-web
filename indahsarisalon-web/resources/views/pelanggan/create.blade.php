        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-2">
                    <h4 class="mb-0 fw-bold text-dark">Tambah Pelanggan Baru</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control bg-light border-0" value="{{ old('username') }}" placeholder="Budi123" required>
                                </div>
                            </div>
                        </div>
