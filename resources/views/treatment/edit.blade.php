                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('treatment.index') }}" class="btn btn-outline-secondary btn-sm p-1 px-2 rounded-pill small">
                        ...
                        <div class="mb-4 text-center">
                            <div id="drop-area" class="upload-zone mb-3">
                                <div id="upload-placeholder" style="{{ $treatment->image ? 'display:none' : '' }}">
                                ...
                                <img id="imagePreview" src="{{ $treatment->image ? 'https://' . env('SUPABASE_PROJECT_REF') . '.supabase.co/storage/v1/object/public/' . env('SUPABASE_BUCKET') . '/' . $treatment->image : '' }}" 
                                     class="img-fluid rounded-3" style="{{ $treatment->image ? '' : 'display:none' }}; max-height: 200px;">
                                <input type="file" name="image" id="imageInput" accept="image/*" hidden>
                            </div>
                            <button type="button" id="removeImage" class="btn btn-outline-danger btn-sm rounded-pill" style="{{ $treatment->image ? '' : 'display:none' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control glass-input" value="{{ $treatment->name }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" name="category" class="form-control border-start-0 ps-0" placeholder="Atau ganti kategori baru...">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="settings-group mb-4 p-3 bg-light rounded-3">
                            <div class="form-check form-switch custom-switch">
                                <input class="form-check-input" type="checkbox" id="allow_multi_select" name="allow_multi_select" value="1" {{ $treatment->allow_multi_select ? 'checked' : '' }}>
                        ...
                        <div class="promo-section">
                            ...
                            <div id="promo_fields" style="{{ $treatment->is_promo ? '' : 'display:none' }}" class="p-3 bg-white border rounded-3 shadow-sm">
                                <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="promo_value" class="form-control glass-input" value="{{ $treatment->promo_value }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="col-md-6 mb-4 detail-item-wrapper">
                                <div class="detail_item detail-card p-4">
                                    ...
                                    <div class="row g-2 mb-3">
                                        <div class="col-7">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="details[{{ $index }}][price]" class="form-control glass-input normal-price-input border-start-0" value="{{ $detail->price }}" {{ $detail->has_stylist_price ? 'disabled' : '' }} required>
                                            </div>
                                        </div>
                                        <div class="col-5">
                                            <label class="small fw-bold mb-1">Durasi</label>
                                            <div class="input-group">
                                                <input type="number" name="details[{{ $index }}][duration]" class="form-control glass-input" value="{{ $detail->duration }}" required>
                                    ...
                                    <div class="stylist-price-toggle-box mb-3">
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" class="form-check-input stylist-price-toggle" 
                                                name="details[{{ $index }}][has_stylist_price]" value="1" id="has_stylist_price_{{ $index }}" {{ $detail->has_stylist_price ? 'checked' : '' }}>
                                            <label class="form-check-label small fw-bold" for="has_stylist_price_{{ $index }}">Gunakan Harga Senior/Junior</label>
                                        </div>
                                    </div>

                                    <div class="stylist-price-container p-3 bg-light rounded-3 mb-3" style="{{ $detail->has_stylist_price ? '' : 'display: none;' }}">
                                        <div class="row g-2">
                                            <div class="col-6">
                                                <label class="extra-small fw-bold mb-1">Senior</label>
                                                <input type="number" name="details[{{ $index }}][price_senior]" class="form-control glass-input form-control-sm stylist-price-input" value="{{ $detail->price_senior }}" {{ $detail->has_stylist_price ? 'required' : '' }}>
                                            </div>
                                            <div class="col-6">
                                                <label class="extra-small fw-bold mb-1">Junior</label>
                                                <input type="number" name="details[{{ $index }}][price_junior]" class="form-control glass-input form-control-sm stylist-price-input" value="{{ $detail->price_junior }}" {{ $detail->has_stylist_price ? 'required' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="details[{{ $index }}][description]" class="form-control glass-input" rows="2">{{ $detail->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="mt-4 border-top pt-4 text-end">
                            <button type="submit" class="btn btn-primary rounded-pill px-5 shadow">
                                <i class="ti ti-circle-check me-1"></i> Perbarui Treatment
                            </button>
                        </div>
                    </div>
                </div>
