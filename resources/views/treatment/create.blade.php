                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4 text-center">
                                    <div id="drop-area" class="upload-zone mb-3">
                                        ...
                                        <img id="imagePreview" class="img-fluid rounded-3"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control glass-input"
                                        placeholder="Contoh: Hair Ritual" required>
                                </div>
                                ...
                                <div class="settings-group mb-4 p-3 bg-light rounded-3">
                                    <div class="form-check form-switch custom-switch">
                                        <input class="form-check-input" type="checkbox" id="allow_multi_select"
                                            name="allow_multi_select" value="1" checked>
                                ...
                                <div class="promo-period-section mt-4 p-3 bg-light rounded-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="target_audience" class="form-select glass-input form-control-sm">
                                            <option value="general">Semua (General)</option>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="promo_end_date" class="form-control glass-input form-control-sm">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4 detail-item-wrapper">
                                        <div class="detail_item detail-card p-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="details[0][name]" class="form-control glass-input"
                                            ...
                                            <div class="row g-2 mb-3">
                                                ...
                                                <div class="col-5">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" name="details[0][duration]"
                                                            class="form-control glass-input" placeholder="0" required>
                                            ...
                                            <div class="stylist-price-toggle-box mb-3">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label small fw-bold"
                                                        for="has_stylist_price_0">Gunakan Harga Senior/Junior</label>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <textarea name="details[0][description]" class="form-control glass-input"
