            ...
            <div class="card shadow-sm border-0 rounded-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('karyawan.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control bg-light border-0" value="{{ old('name') }}" placeholder="Contoh: Budi Santoso" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control bg-light border-0" value="{{ old('username') }}" placeholder="budi_s" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control bg-light border-0" value="{{ old('email') }}" placeholder="budi@example.com" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" class="form-control bg-light border-0" value="{{ old('phone') }}" required placeholder="Contoh: 08123456789">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" class="form-control bg-light border-0" placeholder="Minimal 8 karakter" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0" id="kategoriDiv">
                                ...
                                <select name="kategori" class="form-select bg-light border-0" id="kategoriSelect">
                                    ...
                                    <option value="senior" {{ old('kategori') == 'senior' ? 'selected' : '' }}>Senior Stylist</option>
                                    <option value="junior" {{ old('kategori') == 'junior' ? 'selected' : '' }}>Junior Stylist</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm"><i class="ti ti-device-floppy me-2"></i> Simpan Data</button>
                        </div>
                    </form>
                </div>
            </div>
