        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-2 d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 fw-bold text-dark">Edit Data Pelanggan</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control bg-light border-0" value="{{ old('name', $pelanggan->name) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control bg-light border-0" value="{{ old('username', $pelanggan->username) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control bg-light border-0" value="{{ old('email', $pelanggan->email) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" class="form-control bg-light border-0" value="{{ old('phone', $pelanggan->phone) }}" required placeholder="Contoh: 08123456789">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label class="form-label fw-bold text-muted">Password Baru <small class="text-secondary">(Kosongkan jika tidak diganti)</small></label>
                                <div class="input-group">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('pelanggan.index') }}" class="btn btn-light rounded-pill px-4 btn-cancel">Batal</a>
                            <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm"><i class="ti ti-device-floppy me-2"></i> Update Pelanggan</button>
                        </div>
                    </form>
                </div>
            </div>
